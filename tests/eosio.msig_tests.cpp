...
public:
   eosio_msig_tester() {
      create_accounts( { "eosio.msig"_n, "eosio.stake"_n, "eosio.ram"_n, "eosio.ramfee"_n, "eosio.fee"_n, "alice"_n, "bob"_n, "carol"_n } );
      produce_block();
...
BOOST_FIXTURE_TEST_CASE( update_system_contract_all_approve, eosio_msig_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( core_sym::from_string("1000000000.0000"),
                        ...
                        + get_balance("eosio.ram"_n) + get_balance("eosio.fee"_n) );
